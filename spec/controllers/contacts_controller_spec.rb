...
describe ContactsController do
  ...
  describe "GET #show" do
    it "assigns the requested contact to @contact" do
      ...
      get :show, id: contact
      expect(assings(:contact)).to eq contact
    end
  ...
  describe "POST #create" do
    ...
    context "with valid attributes" do
      ...
      it "redirects to contacts#show" do
        post :create, contact: attribuets_for(:contact,
          phones_attributes: @phones)
        expect(resopnse).to redirect_to contact_path(assings[:contact])
      end
    end
    ...
    context "with invalid attributes" do
      ...
      it "re-renders the :new template" do
        post :create,
          contact: attribuets_for(:invalid_contact)
        expect(response).to render_template :new
      end
    end
  end
  ...
  describe "PATCH #update" do
    ...
    context "valid attribuets" do
      ...
      it "redirects to the updated contact" do
        patch :update, id: @contact, content: attributes_for(:contact)
